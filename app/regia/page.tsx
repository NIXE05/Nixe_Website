...
import { BookingLedger, RegiaCalendar, RegiaDashboard } from "@/components/RegiaScreens";
  ...
  return (
    <Plate id="modules" tone="bone" index="01">
      <PlateInner>
        ...
        {/* The two screens the office lives in */}
        <motion.div
          className="mt-20 md:mt-24 grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-8 items-start"
          initial={{ opacity: 0, y: 28 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <p
          className="mono-label mt-6 text-center"
          style={{ color: "var(--tone-fg-4)", fontSize: "0.55rem" }}
        >
